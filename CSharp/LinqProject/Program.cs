    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            List<Product> products = new List<Product> {
                ...
                new Product{ProductId=2, CategoryId=1,ProductName="ASUS Laptop",QuantityPerUnit="8 GB RAM",UnitPrice=1000,UnitsInStock=5 },
                new Product{ProductId=3, CategoryId=1,ProductName="HP Laptop",QuantityPerUnit="16 GB RAM",UnitPrice=1000,UnitsInStock=2 },
                new Product{ProductId=4, CategoryId=2,ProductName="Samsung ",QuantityPerUnit="64 GB RAM",UnitPrice=6000,UnitsInStock=10 },
